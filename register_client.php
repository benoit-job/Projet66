...
{
    if(isset($_POST['nom']) && isset($_POST['prenom']) && isset($_POST['email']) && isset($_POST['contact']) && isset($_POST['sexe']) && isset($_POST['datenaissance']) && isset($_POST['localisation']) && isset($_POST['password']) && isset($_FILES['photo']))
    {
        if(!empty($_POST['nom']) && !empty($_POST['prenom']) && !empty($_POST['email']) && !empty($_POST['contact']) && !empty($_POST['sexe']) && !empty($_POST['datenaissance']) && !empty($_POST['localisation']) && !empty($_POST['nationalite']) && !empty($_POST['password']) && !empty($_FILES['photo']['name']))
        {
            ...
            $movefile = move_uploaded_file($tmp,'photo_clients/'.$newfilename);
            if($movefile)
            {
                ...
                $insertUser = $bdd->prepare('INSERT INTO clients(nom , prenom, email, contact, sexe, datenaissance, localisation, nationalite, password,photo) VALUES(?,?,?,?,?,?,?,?,?,?)');
                $insertUser->execute(array($nom , $prenom, $email, $contact, $sexe, $datenaissance, $localisation, $nationalite, $password, $newfilename));
